...
ScrollReveal().remove(".header__content h2", {
    ...scrollRevealOption,
    delay:500,
});

ScrollReveal().remove(".header__content h1", {
    ...scrollRevealOption,
    delay:1000,
});

ScrollReveal().remove(".header__content .section__description", {
    ...scrollRevealOption,
    delay:1500,
});

ScrollReveal().remove(".header__form form", {
    ...scrollRevealOption,
    delay:2000,
});
...
tabs.addEventListener ("click", (e) =>{
    ...
    Array.from(tabs.children).forEach((item)=>{
        if (item.dataset.id ===e.target.dataset.id){
            ...
            item.classLinkst.remove("active");
        }
    });
